...
Future<dynamic> pushReplacement(Widget page, {Object? arguments}) {
  return Navigator.of(navigatorKey.currentContext!).pushReplacement(MaterialPageRoute(builder: (c) => page));
}

pop({Object? result}) => Navigator.pop(navigatorKey.currentContext!, result);
