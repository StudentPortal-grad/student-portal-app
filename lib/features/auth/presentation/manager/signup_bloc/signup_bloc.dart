  ...
  Future<void> _onUpdateDataRequested(
    ...
    var data = await updateDataUc.call(
      CompleteDto(
        ...
        gpa: gpaController.text.trim().isEmpty || position?.toLowerCase() != 'student' ? null : double.parse(gpaController.text),
        level: levelController.text.trim().isEmpty || position?.toLowerCase() != 'student' ? null : int.parse(levelController.text),
