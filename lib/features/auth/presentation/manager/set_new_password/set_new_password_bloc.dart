...
class SetNewPasswordBloc
  ...
  final ResetPasswordUc resetPasswordUc = ResetPasswordUc(authRepository: getIt.get<AuthRepository>());
  ...
  Future<void> _onSetNewPasswordRequested(
    ...
    emit(SetNewPasswordLoading());
      ...
      String? resetToken = await getIt<SecureStorage>().readResetTokenData();
      if (resetToken == null) {
